 ...
 * Source Class: DefaultPassenger <br>
 * @version generated on Sat Sep 18 09:05:49 CEST 2021 by barto
 */
public class DefaultPassenger extends WrappedIndividualImpl implements Passenger {

    public DefaultPassenger(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Boolean> getHasSeatbelt() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSEATBELT, Boolean.class);
    }

    public boolean hasHasSeatbelt() {
		return !getHasSeatbelt().isEmpty();
    }

    public void addHasSeatbelt(Boolean newHasSeatbelt) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSEATBELT, newHasSeatbelt);
    }

    public void removeHasSeatbelt(Boolean oldHasSeatbelt) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSEATBELT, oldHasSeatbelt);
    }
    ...
    public Collection<? extends String> getSeat() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SEAT, String.class);
    }
    ...
    public void addSeat(String newSeat) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SEAT, newSeat);
    }

    public void removeSeat(String oldSeat) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SEAT, oldSeat);
    }
