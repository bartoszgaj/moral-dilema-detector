...
public class DefaultDriver extends WrappedIndividualImpl implements Driver {
    ...
    public Collection<? extends WrappedIndividual> getFitness() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_FITNESS,
                                               WrappedIndividualImpl.class);
    }
    ...
    public void addFitness(WrappedIndividual newFitness) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_FITNESS,
                                       newFitness);
    }

    public void removeFitness(WrappedIndividual oldFitness) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_FITNESS,
                                          oldFitness);
    }
    ...
    public Collection<? extends WrappedIndividual> getHas_seatbelt() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_SEATBELT,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasHas_seatbelt() {
	   return !getHas_seatbelt().isEmpty();
    }

    public void addHas_seatbelt(WrappedIndividual newHas_seatbelt) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_SEATBELT,
                                       newHas_seatbelt);
    }

    public void removeHas_seatbelt(WrappedIndividual oldHas_seatbelt) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_SEATBELT,
                                          oldHas_seatbelt);
    }
    ...
    public Collection<? extends WrappedIndividual> getHealth() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HEALTH,
                                               WrappedIndividualImpl.class);
    }
    ...
    public void addHealth(WrappedIndividual newHealth) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HEALTH,
                                       newHealth);
    }

    public void removeHealth(WrappedIndividual oldHealth) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HEALTH,
                                          oldHealth);
    }
    ...
    public Collection<? extends WrappedIndividual> getSeat() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_SEAT,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasSeat() {
	   return !getSeat().isEmpty();
    }

    public void addSeat(WrappedIndividual newSeat) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_SEAT,
                                       newSeat);
    }

    public void removeSeat(WrappedIndividual oldSeat) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_SEAT,
                                          oldSeat);
    }
    ...
    public Collection<? extends WrappedIndividual> getWeight() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_WEIGHT,
                                               WrappedIndividualImpl.class);
    }
    ...
    public void addWeight(WrappedIndividual newWeight) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_WEIGHT,
                                       newWeight);
    }

    public void removeWeight(WrappedIndividual oldWeight) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_WEIGHT,
                                          oldWeight);
    }
