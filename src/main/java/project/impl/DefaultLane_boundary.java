 ...
 * Source Class: DefaultLane_boundary <br>
 * @version generated on Sat Sep 18 09:05:52 CEST 2021 by barto
 */
public class DefaultLane_boundary extends WrappedIndividualImpl implements Lane_boundary {

    public DefaultLane_boundary(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends String> getColor() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_COLOR, String.class);
    }
    ...
    public void removeColor(String oldColor) {
    ...
    public Collection<? extends String> getMaterial() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_MATERIAL, String.class);
    }
    ...
    public void addMaterial(String newMaterial) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_MATERIAL, newMaterial);
    }

    public void removeMaterial(String oldMaterial) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_MATERIAL, oldMaterial);
    }
