 ...
 * Source Class: DefaultConditional_discharge <br>
 * @version generated on Sat Sep 18 09:53:33 CEST 2021 by barto
 */
public class DefaultConditional_discharge extends WrappedIndividualImpl implements Conditional_discharge {

    public DefaultConditional_discharge(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends WrappedIndividual> getConditional_discharge_length() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CONDITIONAL_DISCHARGE_LENGTH,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasConditional_discharge_length() {
	   return !getConditional_discharge_length().isEmpty();
    }

    public void addConditional_discharge_length(WrappedIndividual newConditional_discharge_length) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONDITIONAL_DISCHARGE_LENGTH,
                                       newConditional_discharge_length);
    }

    public void removeConditional_discharge_length(WrappedIndividual oldConditional_discharge_length) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_CONDITIONAL_DISCHARGE_LENGTH,
                                          oldConditional_discharge_length);
    }
