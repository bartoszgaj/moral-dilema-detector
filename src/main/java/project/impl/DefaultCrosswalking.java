 ...
 * Source Class: DefaultCrosswalking <br>
 * @version generated on Sat Sep 18 09:53:33 CEST 2021 by barto
 */
public class DefaultCrosswalking extends WrappedIndividualImpl implements Crosswalking {

    public DefaultCrosswalking(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Surrounding> getHas_surrounding_left() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_LEFT,
                                               DefaultSurrounding.class);
    }

    public boolean hasHas_surrounding_left() {
	   return !getHas_surrounding_left().isEmpty();
    }

    public void addHas_surrounding_left(Surrounding newHas_surrounding_left) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_LEFT,
                                       newHas_surrounding_left);
    }

    public void removeHas_surrounding_left(Surrounding oldHas_surrounding_left) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_LEFT,
                                          oldHas_surrounding_left);
    }
    ...
    public Collection<? extends Surrounding> getHas_surrounding_right() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_RIGHT,
                                               DefaultSurrounding.class);
    }

    public boolean hasHas_surrounding_right() {
	   return !getHas_surrounding_right().isEmpty();
    }

    public void addHas_surrounding_right(Surrounding newHas_surrounding_right) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_RIGHT,
                                       newHas_surrounding_right);
    }

    public void removeHas_surrounding_right(Surrounding oldHas_surrounding_right) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_SURROUNDING_RIGHT,
                                          oldHas_surrounding_right);
    }
