...
public class DefaultLane extends WrappedIndividualImpl implements Lane {
    ...
    public Collection<? extends Lane_boundary> getHas_left_side_boundary() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_LEFT_SIDE_BOUNDARY,
                                               DefaultLane_boundary.class);
    }

    public boolean hasHas_left_side_boundary() {
	   return !getHas_left_side_boundary().isEmpty();
    }

    public void addHas_left_side_boundary(Lane_boundary newHas_left_side_boundary) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_LEFT_SIDE_BOUNDARY,
                                       newHas_left_side_boundary);
    }

    public void removeHas_left_side_boundary(Lane_boundary oldHas_left_side_boundary) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_LEFT_SIDE_BOUNDARY,
                                          oldHas_left_side_boundary);
    }
    ...
    public Collection<? extends Lane_boundary> getHas_right_side_boundary() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_RIGHT_SIDE_BOUNDARY,
                                               DefaultLane_boundary.class);
    }

    public boolean hasHas_right_side_boundary() {
	   return !getHas_right_side_boundary().isEmpty();
    }

    public void addHas_right_side_boundary(Lane_boundary newHas_right_side_boundary) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_RIGHT_SIDE_BOUNDARY,
                                       newHas_right_side_boundary);
    }

    public void removeHas_right_side_boundary(Lane_boundary oldHas_right_side_boundary) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_RIGHT_SIDE_BOUNDARY,
                                          oldHas_right_side_boundary);
    }
    ...
    public Collection<? extends Non_living_entity> getLane_has_object() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_LANE_HAS_OBJECT,
                                               DefaultNon_living_entity.class);
    }

    public boolean hasLane_has_object() {
	   return !getLane_has_object().isEmpty();
    }

    public void addLane_has_object(Non_living_entity newLane_has_object) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_LANE_HAS_OBJECT,
                                       newLane_has_object);
    }

    public void removeLane_has_object(Non_living_entity oldLane_has_object) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_LANE_HAS_OBJECT,
                                          oldLane_has_object);
    }
    ...
    public Collection<? extends Living_entity> getLane_has_pedestrian() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_LANE_HAS_PEDESTRIAN,
                                               DefaultLiving_entity.class);
    }

    public boolean hasLane_has_pedestrian() {
	   return !getLane_has_pedestrian().isEmpty();
    }

    public void addLane_has_pedestrian(Living_entity newLane_has_pedestrian) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_LANE_HAS_PEDESTRIAN,
                                       newLane_has_pedestrian);
    }

    public void removeLane_has_pedestrian(Living_entity oldLane_has_pedestrian) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_LANE_HAS_PEDESTRIAN,
                                          oldLane_has_pedestrian);
    }
    ...
    public Collection<? extends Vehicle> getLane_has_vehicle() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_LANE_HAS_VEHICLE,
                                               DefaultVehicle.class);
    }

    public boolean hasLane_has_vehicle() {
	   return !getLane_has_vehicle().isEmpty();
    }

    public void addLane_has_vehicle(Vehicle newLane_has_vehicle) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_LANE_HAS_VEHICLE,
                                       newLane_has_vehicle);
    }

    public void removeLane_has_vehicle(Vehicle oldLane_has_vehicle) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_LANE_HAS_VEHICLE,
                                          oldLane_has_vehicle);
    }
    ...
    public Collection<? extends Integer> getLane_number() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_LANE_NUMBER, Integer.class);
    }

    public boolean hasLane_number() {
		return !getLane_number().isEmpty();
    }

    public void addLane_number(Integer newLane_number) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_LANE_NUMBER, newLane_number);
    }

    public void removeLane_number(Integer oldLane_number) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_LANE_NUMBER, oldLane_number);
    }
