...
public interface Driver extends Passenger, Human {
    ...
    /* ***************************************************
     * Property http://webprotege.stanford.edu/driver_makes_action
     */
     
    /**
     * Gets all property values for the driver_makes_action property.<p>
     * 
     * @returns a collection of values for the driver_makes_action property.
     */
    Collection<? extends Driver_action> getDriver_makes_action();

    /**
     * Checks if the class has a driver_makes_action property value.<p>
     * 
     * @return true if there is a driver_makes_action property value.
     */
    boolean hasDriver_makes_action();

    /**
     * Adds a driver_makes_action property value.<p>
     * 
     * @param newDriver_makes_action the driver_makes_action property value to be added
     */
    void addDriver_makes_action(Driver_action newDriver_makes_action);

    /**
     * Removes a driver_makes_action property value.<p>
     * 
     * @param oldDriver_makes_action the driver_makes_action property value to be removed.
     */
    void removeDriver_makes_action(Driver_action oldDriver_makes_action);
     ...
     */
    Collection<? extends WrappedIndividual> getFitness();
     ...
     */
    void addFitness(WrappedIndividual newFitness);
     ...
     */
    void removeFitness(WrappedIndividual oldFitness);


    /* ***************************************************
     * Property http://webprotege.stanford.edu/project/BDGSqwMbfBgw7pUJ8IOnJ1#has_seatbelt
     */
     
    /**
     * Gets all property values for the has_seatbelt property.<p>
     * 
     * @returns a collection of values for the has_seatbelt property.
     */
    Collection<? extends WrappedIndividual> getHas_seatbelt();

    /**
     * Checks if the class has a has_seatbelt property value.<p>
     * 
     * @return true if there is a has_seatbelt property value.
     */
    boolean hasHas_seatbelt();

    /**
     * Adds a has_seatbelt property value.<p>
     * 
     * @param newHas_seatbelt the has_seatbelt property value to be added
     */
    void addHas_seatbelt(WrappedIndividual newHas_seatbelt);

    /**
     * Removes a has_seatbelt property value.<p>
     * 
     * @param oldHas_seatbelt the has_seatbelt property value to be removed.
     */
    void removeHas_seatbelt(WrappedIndividual oldHas_seatbelt);
     ...
     */
    Collection<? extends WrappedIndividual> getHealth();
     ...
     */
    void addHealth(WrappedIndividual newHealth);
     ...
     */
    void removeHealth(WrappedIndividual oldHealth);
     ...
     */
    Collection<? extends WrappedIndividual> getSeat();
     ...
     */
    void addSeat(WrappedIndividual newSeat);
     ...
     */
    void removeSeat(WrappedIndividual oldSeat);
     ...
     */
    Collection<? extends WrappedIndividual> getWeight();
     ...
     */
    void addWeight(WrappedIndividual newWeight);
     ...
     */
    void removeWeight(WrappedIndividual oldWeight);
