 ...
 * Source Class: Conditional_discharge <br>
 * @version generated on Sat Sep 18 09:05:47 CEST 2021 by barto
 */

public interface Conditional_discharge extends Restriction_of_liberty {

    /* ***************************************************
     * Property http://webprotege.stanford.edu/conditional_discharge_length
     */
     
    /**
     * Gets all property values for the conditional_discharge_length property.<p>
     * 
     * @returns a collection of values for the conditional_discharge_length property.
     */
    Collection<? extends WrappedIndividual> getConditional_discharge_length();

    /**
     * Checks if the class has a conditional_discharge_length property value.<p>
     * 
     * @return true if there is a conditional_discharge_length property value.
     */
    boolean hasConditional_discharge_length();

    /**
     * Adds a conditional_discharge_length property value.<p>
     * 
     * @param newConditional_discharge_length the conditional_discharge_length property value to be added
     */
    void addConditional_discharge_length(WrappedIndividual newConditional_discharge_length);

    /**
     * Removes a conditional_discharge_length property value.<p>
     * 
     * @param oldConditional_discharge_length the conditional_discharge_length property value to be removed.
     */
    void removeConditional_discharge_length(WrappedIndividual oldConditional_discharge_length);
